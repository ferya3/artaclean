...
return [
    ...
    'surface_type' => [
        ...
        'tile' => 'سرامیک و سنگ',
        'carpet' => 'فرش و موکت',
        'upholstery' => 'مبلمان و صندلی',
        'machinery' => 'ماشین‌آلات و تجهیزات',
        'vertical' => 'دیوار و سطوح عمودی',
        'outdoor' => 'محوطه باز و آسفالت',
    ],

    'nav_group' => [
        'floor' => 'نظافت کف',
        'pressure' => 'شست‌وشوی فشار بالا',
        'specialist' => 'نظافت تخصصی',
        'consumable' => 'مواد مصرفی و قطعات',
    ],

    'knowledge_type' => [
        'guide' => 'راهنمای خرید',
        'cleaning' => 'راهنمای نظافت',
        'comparison' => 'مقایسه دستگاه‌ها',
        'case_study' => 'پروژه اجرا شده',
        'video' => 'ویدئو',
        'article' => 'مقاله',
    ],
