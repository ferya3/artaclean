    ...
    <template x-teleport="body">
        <div class="lg:hidden">
            ...
            <div id="mobile-nav"
                ...
                <div class="menu-reveal flex-1 space-y-1 overflow-y-auto overscroll-contain px-5 py-4">
                    ...
                    {{-- Marks where the machine lists stop and the rest of the site starts. --}}
                    <span class="my-3 block h-px bg-ink-100"></span>
